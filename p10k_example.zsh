# Generated by Powerlevel10k configuration wizard on 2023-01-31 at 18:50 -04.
...
() {
  ...
  # Branch icon. Set this parameter to '\UE0A0 ' for the popular Powerline branch icon. Default: '\uF126'
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=71
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=71
  ...
  ################[ pyenv: python environment (https://github.com/pyenv/pyenv) ]################
  # Pyenv color.
  typeset -g POWERLEVEL9K_PYENV_FOREGROUND=71
